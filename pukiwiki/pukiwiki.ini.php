...
$page_title = 'NokoLAT wiki';

// Specify PukiWiki URL (default: auto)
$script = 'http://www.tuat.ac.jp/~birdman/pukiwiki/';

// Shorten $script: Cut its file name (default: not cut)
//$script_directory_index = 'index.php';

// Site admin's name (CHANGE THIS)
$modifier = 'TUATBM - NoKoLAT';

// Site admin's Web page (CHANGE THIS)
$modifierlink = 'http://www.tuat.ac.jp/~birdman/';

// Default page name
$defaultpage  = '東京農工大学航空研究会';     // Top / Default page
...
// Default: always fail
$adminpass = '{x-php-md5}2bc7b1acfe6cef0bd2d77740446afd10';
...
$auth_users = array(
	// Username => password
	'TUATBM'	=> '{x-php-md5}71c4dddd1a1051c8f8b6c95fa72d18a1',
);
